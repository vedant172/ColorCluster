...
public class Ad_L8 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L8 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text4_extra_color.instance.Score;
        Main_text4_extra_color.instance.ContinuePanel.SetActive(true);
        Main_text4_extra_color.instance.GameOverPanel.SetActive(false);
    }
}
