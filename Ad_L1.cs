...
public class Ad_L1 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L1 instance;
    ...
    public void showRewardedAd()
    {
        ...
        {
            NewtworkText.text = "Check internet connection!";
        ...
        else
        {
            ...
            {
                NewtworkText.text = "video is not available";
                NewtworkText.enabled = true;
                StartCoroutine(Next_Text_manage());
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text1.instance.Score;
        Main_text1.instance.ContinuePanel.SetActive(true);
        Main_text1.instance.GameOverPanel.SetActive(false);
    }
}
