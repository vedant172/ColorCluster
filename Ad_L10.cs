...
public class Ad_L10 : MonoBehaviour
{
    public Text NewtworkText;
    
    public static Ad_L10 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text5_text_color.instance.Score;
        Main_text5_text_color.instance.ContinuePanel.SetActive(true);
        Main_text5_text_color.instance.GameOverPanel.SetActive(false);
    }
}
