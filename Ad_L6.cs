...
public class Ad_L6 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L6 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text3_text_color.instance.Score;
        Main_text3_text_color.instance.ContinuePanel.SetActive(true);
        Main_text3_text_color.instance.GameOverPanel.SetActive(false);
    }
}
