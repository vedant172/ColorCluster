...
public class Main_text2 : MonoBehaviour
{
    ...
    public static Main_text2 instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore2");
        if (HSNext >= 60)
        {
    ...
    void Update()
    {
        ...
        if (Score <= 3)                                 //ch
        {
            ...
            if (KeyColor == 4) Arrow_p.SetActive(true);
            if (KeyColor == 5) Arrow_pu.SetActive(true);
            if (KeyColor == 6) Arrow_o.SetActive(true);
        }
