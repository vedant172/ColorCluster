...
public class Main_text8_text_color : MonoBehaviour
{
    ...
    public static Main_text8_text_color instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore8_text_color");
        if (HSNext >= 100)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore8_text_color") < Score)
        {
            PlayerPrefs.SetInt("highscore8_text_color", Score);
        }
        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore8_text_color");     
