...
public class Ad_L7 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L7 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text4.instance.Score;
        Main_text4.instance.ContinuePanel.SetActive(true);
        Main_text4.instance.GameOverPanel.SetActive(false);
    }
}
