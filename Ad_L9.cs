...
public class Ad_L9 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L9 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text5.instance.Score;
        Main_text5.instance.ContinuePanel.SetActive(true);
        Main_text5.instance.GameOverPanel.SetActive(false);
    }
}
