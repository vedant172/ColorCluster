...
public class Ad_L5 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L5 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text3.instance.Score;
        Main_text3.instance.ContinuePanel.SetActive(true);
        Main_text3.instance.GameOverPanel.SetActive(false);
    }
}
