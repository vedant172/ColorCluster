...
public class Main_text4 : MonoBehaviour
{
    ...
    public static Main_text4 instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore4");
        if (HSNext >= 80)
        {
    ...
    public void PickRandomList()
    {
       ...
       // KeyColor = Random.Range(0, colour.Length);
        ...
        //if( Random_num_text_number_prev == Random_num_text_number)
        //{
        //    PickRandomList();
        //}
        Arrow_r1.SetActive(false);  //Ch
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore4") < Score)
        {
