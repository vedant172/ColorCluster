...
public class Ad_L15 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L15 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text8.instance.Score;
        Main_text8.instance.ContinuePanel.SetActive(true);
        Main_text8.instance.GameOverPanel.SetActive(false);
    }
}
