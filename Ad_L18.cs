...
public class Ad_L18 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L18 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text9_text_color.instance.Score;
        Main_text9_text_color.instance.ContinuePanel.SetActive(true);
        Main_text9_text_color.instance.GameOverPanel.SetActive(false);
    }
}
