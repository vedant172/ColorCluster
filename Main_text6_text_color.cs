...
public class Main_text6_text_color : MonoBehaviour
{
    ...
    public static Main_text6_text_color instance;
    ...
    public int key = 0;
    public int PreKey = 0;
    public int KeyColor = 0; // text name of color
    public int PreKeyColor = 0;
    public Button[] button;
    public int TextColourKey = 0; // for buttons
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore6_text_color");
        if (HSNext >= 100)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore6_text_color") < Score)
        {
            PlayerPrefs.SetInt("highscore6_text_color", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore6_text_color");      
