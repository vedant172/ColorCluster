...
public class Main_text10 : MonoBehaviour
{
    ...
    public static Main_text10 instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore10");
        if (HSNext >= 100)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore10") < Score)
        {
            PlayerPrefs.SetInt("highscore10", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore10");     
