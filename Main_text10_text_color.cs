...
public class Main_text10_text_color : MonoBehaviour
{
    ...
    public static Main_text10_text_color instance;
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore10_text_color") < Score)
        {
            PlayerPrefs.SetInt("highscore10_text_color", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore10_text_color");
