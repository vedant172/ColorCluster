...
public class Main_text2_text_color : MonoBehaviour
{
    ...
    public static Main_text2_text_color instance;
    ...
    public GameObject Arrow_o;
    public GameObject Arrow_p;
    public GameObject Arrow_pu;
    ...
    void Start()
    {
        ...
        Arrow_o.SetActive(false);
        Arrow_p.SetActive(false);
        Arrow_pu.SetActive(false);
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore2_text_color");
        if (HSNext >= 70)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore2_text_color") < Score)
        {
            PlayerPrefs.SetInt("highscore2_text_color", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore2_text_color");
    ...
    void Update()
    {
        ...
        if (Score <= 3)                                 //ch
        {
            ...
            if (text_color_key == 4) Arrow_p.SetActive(true);
            if (text_color_key == 5) Arrow_pu.SetActive(true);
            if (text_color_key == 6) Arrow_o.SetActive(true);
        }
