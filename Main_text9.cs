...
public class Main_text9 : MonoBehaviour
{
    ...
    public static Main_text9 instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore9");
        if (HSNext >= 100)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore9") < Score)
        {
            PlayerPrefs.SetInt("highscore9", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore9");   
