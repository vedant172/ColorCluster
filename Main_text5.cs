...
public class Main_text5 : MonoBehaviour
{
    ...
    public static Main_text5 instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore5");
        if (HSNext >= 90)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore5") < Score)
        {
            PlayerPrefs.SetInt("highscore5", Score);
        }

        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore5");     
