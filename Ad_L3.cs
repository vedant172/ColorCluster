...
public class Ad_L3 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L3 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text2.instance.Score;
        Main_text2.instance.ContinuePanel.SetActive(true);
        Main_text2.instance.GameOverPanel.SetActive(false);
    }
}
