...
public class Main_text3_text_color : MonoBehaviour
{
    ...
    public static Main_text3_text_color instance;
    ...
    public void Next() //ch
    {
        ...
        HSNext = PlayerPrefs.GetInt("highscore3_text_color");
        if (HSNext >= 80)
        {
    ...
    public void GameOver()
    {
        ...
        if (PlayerPrefs.GetInt("highscore3_text_color") < Score)
        {
            PlayerPrefs.SetInt("highscore3_text_color", Score);
        }
        HighScoreText.text = "HIGH SCORE: " + PlayerPrefs.GetInt("highscore3_text_color");     
