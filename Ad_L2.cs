...
public class Ad_L2 : MonoBehaviour
{
    public Text NewtworkText;
    public static Ad_L2 instance;
    ...
    public void HandleUserEarnedReward(object sender, Reward args)
    {
        ...
        Continue_score.text = "SCORE: " + Main_text1_text_color.instance.Score;
        Main_text1_text_color.instance.ContinuePanel.SetActive(true);
        Main_text1_text_color.instance.GameOverPanel.SetActive(false);
    }
}
